...
const Page = () => (
  <Layout>
    ...
    <div className="color-text py-5">
      ...
      <p className="my-0 pt-4">*please let us know your name, contact information,</p>
      <p className="my-0">and the desired date and time you wish to view the exhibition .</p>
    </div>
  </Layout>
)
